...
---
*Ce document évoluera avec le projet, gardez-le à jour lors d'ajouts architecturaux majeurs (ex: passage à Redux/Zustand si nécessaire, ou migration TypeScript complète).*
