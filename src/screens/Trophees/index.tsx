...
const TropheesPage = () => {
  ...
  const appTrophiesWithState = useMemo(() => {
    ...
    return achievements
      ...
      .filter((trophy: any) => !trophy.isHidden || trophy.unlocked)
      .sort((a: any, b: any) => {
        if (a.unlocked === b.unlocked) {
          const rarityOrder: Record<string, number> = { bronze: 1, argent: 2, or: 3, platine: 4 }
  ...
  return (
    <div className="trophees-page">
      ...
      <section className="trophees-list" aria-live="polite">
        ...
        {!isLoading && !error
          ? appTrophiesWithState.map((entry: any) => (
              <article
