      ...
      {isLoading || isLoadingSync ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
          {THEME_CATEGORIES_DATA.map((category) => {
            ...
            const categoryThemes = category.themes
              .map((tInfo) => {
            ...
            const cleanTitle = category.title
              .replace(
                /^[\p{Emoji_Presentation}\p{Extended_Pictographic}\uFE0F\u200D\p{M}]+\s*/gu,
                ''
              ) // Retire les émojis en début de titre
              .trim()
                  ...
                  {categoryThemes.map((theme) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <h3 style={{ margin: 0, fontSize: '1.1rem', color: textColor }}>
