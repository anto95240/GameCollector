      ...
      try {
        ...
        setOptionsData({
          genre: [
            ...
            ...meta.genres.map((g) => ({ value: g._id, label: g.genre_name })),
          ],
          platform: [
            { value: '', label: 'Sélectionner une plateforme' },
            ...meta.platforms.map((p) => ({ value: p._id, label: p.platform_name })),
          ],
          status: [
            { value: '', label: 'Sélectionner un statut' },
            ...meta.statuses.map((s) => ({ value: s._id, label: s.status_name })),
          ],
          rating: MOCK_OPTIONS.rating,
        })
        return meta.tags || []
