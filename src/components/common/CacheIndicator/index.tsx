...
export const CacheIndicator = ({ isCached, size = 'md', showLabel = false }: { isCached: boolean; size?: string; showLabel?: boolean }) => {
...
export const CacheBadge = ({ className = '' }: { className?: string }) => (
...
export const CacheLabel = ({ className = '' }: { className?: string }) => (
