...
const DeleteAccountSection = ({ setUiState, t }: any) => {
  ...
  return (
    ...
    >
      <div className="delete-content-row" style={{ display: 'flex', flexDirection: 'column', alignItems: 'stretch', gap: '0', width: '100%' }}>
        <InlineFormItem
          ...
          hideInput={true}
        >
          <div className="delete-warning-container" style={{ marginTop: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)' }}>
            <p className="delete-warning-text" style={{ margin: 0, opacity: 0.8, fontSize: '14px' }}>
