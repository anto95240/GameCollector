        ...
        <div className="top-games-list">
          ...
          {topGames.map((g, i) => (
            <div key={g._id} className="top-game-row">
              ...
              <div className="top-game-cover" style={g.imageUrl ? { backgroundImage: `url("${g.imageUrl}")` } : {}} />
              ...
              <div className="top-game-rating">
                <span className="rating-num">{g.note}/5 <FontAwesomeIcon icon={faStar} className="star-filled" /></span>
              </div>
            </div>
          ))}
        </div>
