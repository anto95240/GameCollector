...
const BarShape = ({ x, y, width, height, fill, onHover, index }) => (
  <rect
    x={x}
    y={y}
    width={width}
...
const YearChart = ({ stats }) => {
  ...
  const handleHover = (index, geometry) => {
    ...
    <div className="year-chart-wrapper">
      <div className="year-chart-content">
        <div className="year-chart-header">
          <span style={{color: "var(--text-primary)", fontWeight: "bold", textTransform: "uppercase"}}>{t("statistics.barChart.gamesByYear")}</span>
        </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar
                dataKey="count"
                radius={[4, 4, 0, 0]}
                shape={barProps => <BarShape {...barProps} onHover={handleHover} />}
              >
