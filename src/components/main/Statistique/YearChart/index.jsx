        ...
        <div className="year-chart-wrapper">
            <div className="year-chart-content">
                ...
                <div className="year-chart-container">
                    {isLoading ? (
                        <p className="loading-text" style={{textAlign: 'center', marginTop: '50px'}}>Chargement...</p>
                    ) : currentData.length === 0 ? (
                        <p style={{textAlign: 'center', marginTop: '50px', color: 'var(--text-secondary)'}}>Aucune donnée disponible</p>
                    ) : (
                        <>
                            <ResponsiveContainer>
